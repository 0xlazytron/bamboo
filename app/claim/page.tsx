    ...
    return (
        <div className="pt-24 px-4 container mx-auto min-h-screen max-w-2xl">
            ...
            >
                ...
                <h1 className="text-4xl font-bold mb-4 bg-gradient-to-r from-purple-400 via-teal-400 to-orange-400 bg-clip-text text-transparent">Claim Your Free T-Shirt</h1>
            ...
            >
                <div>
                    <label className="block text-sm font-medium mb-2 text-gray-300">T-Shirt Size</label>
                    <select
                        className="w-full glass bg-purple-500 p-3 rounded-lg text-gray-300 outline-none"
                        value={formData.size}
                ...
                <div>
                    <label className="block text-sm font-medium mb-2 text-gray-300">Shipping Address</label>
                    <input
                        type="text"
                ...
                >
                    ...
                    <span className="text-gray-300">Claim Your T-Shirt</span>
                </button>
            </motion.form>
        </div>
    );
